...
TARGET_BRANCH="phase-conditioned-recurrence"
...
export PHASE_COUNT="${PHASE_COUNT:-4}"
export PHASE_MOD_STRENGTH="${PHASE_MOD_STRENGTH:-0.2}"
...
export RUN_ID="${RUN_ID:-phase_conditioned_${NPROC_PER_NODE}gpu_${ITER_TAG}_${STAMP}}"
