...
export PREDICTIVE_DELTA_STRENGTH="${PREDICTIVE_DELTA_STRENGTH:-0.5}"
export PREDICTIVE_DELTA_CLAMP="${PREDICTIVE_DELTA_CLAMP:-2.0}"
...
export RUN_ID="${RUN_ID:-predictive_coding_${NPROC_PER_NODE}gpu_${ITER_TAG}_${STAMP}}"
